...
public class PasswordField extends JPasswordField {
    ...
    public PasswordField() {
        ...
        eye = new ImageIcon(getClass().getResource("/custom_components/eye.png")).getImage();
        eye_hide = new ImageIcon(getClass().getResource("/custom_components/eye_hide.png")).getImage();
