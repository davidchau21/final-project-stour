...
public class FrmDangNhapKhachHang extends javax.swing.JFrame {
    ...
    private void xuLyDangNhap(String taiKhoan, String pass) {
        
        // Xu ly dang nhap theo ten tai khoan
        
        TaiKhoanKH taiKhoanKH = TaiKhoanKH_DAO.getTaiKhoanKH(taiKhoan);
       
        if(taiKhoanKH == null)
        {   
            // Xu ly dang nhap theo so dien thoai
            
            DuKhach duKhach = DuKhach_DAO.getDuKhachTheoSDT(taiKhoan);
        
            if(duKhach == null)
            {
                lblError.setText("Không tìm thấy tên tài khoản hoặc số điện thoại phù hợp");
                return;
            }
            
            taiKhoanKH = TaiKhoanKH_DAO.getTaiKhoanKHTheoMaDK(duKhach.getMaDK());
        
            if(taiKhoanKH == null)
            {
                lblError.setText("Tài khoản này đã bị xóa");
                return;
            }
        }
        
        if(taiKhoanKH.getMatKhau().compareTo(HashCode.toHashCode(pass)) != 0)
        {
        ...
        // Dang nhap
        Application.taiKhoanKH = taiKhoanKH;
    ...
    private void initComponents() {
        ...
        btnLoginWithNhanVien = new custom_components.ButtonCustom();
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/background_login3.jpg"))); // NOI18N
        ...
        jLabel3.setFont(new java.awt.Font("Mulish Medium", 1, 24)); // NOI18N
        ...
        txtTaiKhoan.setFont(new java.awt.Font("Mulish Light", 0, 15)); // NOI18N
        txtTaiKhoan.setForeground(new java.awt.Color(100, 100, 100));
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txtTaiKhoan, javax.swing.GroupLayout.DEFAULT_SIZE, 37, Short.MAX_VALUE)
        ...
        btnDangKy.setForeground(new java.awt.Color(62, 140, 251));
        btnDangKy.setText("Đăng ký");
        btnDangKy.setBorderColor(new java.awt.Color(240, 240, 240));
        btnDangKy.setColorClick(new java.awt.Color(245, 245, 245));
        btnDangKy.setColorHover(new java.awt.Color(245, 245, 245));
        ...
        jLabel9.setFont(new java.awt.Font("Mulish Medium", 0, 28)); // NOI18N
        ...
        btnLoginWithNhanVien.setBackground(new java.awt.Color(255, 204, 0));
        btnLoginWithNhanVien.setBorder(null);
        btnLoginWithNhanVien.setForeground(new java.awt.Color(255, 255, 255));
        btnLoginWithNhanVien.setText("NHÂN VIÊN");
        btnLoginWithNhanVien.setBorderColor(new java.awt.Color(255, 204, 0));
        btnLoginWithNhanVien.setColor(new java.awt.Color(255, 204, 0));
        btnLoginWithNhanVien.setColorClick(new java.awt.Color(255, 204, 102));
        btnLoginWithNhanVien.setColorHover(new java.awt.Color(255, 204, 102));
        btnLoginWithNhanVien.setFont(new java.awt.Font("Mulish", 1, 12)); // NOI18N
        btnLoginWithNhanVien.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                btnLoginWithNhanVienMousePressed(evt);
            }
        });
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btnLoginWithNhanVien, javax.swing.GroupLayout.PREFERRED_SIZE, 89, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(102, 102, 102))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btnLoginWithNhanVien, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(19, 19, 19)
    ...
    private void btnDangNhapMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDangNhapMousePressed
        ...
        if(taiKhoan.isEmpty())
        {
            lblError.setText("Tài khoản không được để trống");
            return;
        }
        if(pass.isEmpty())
        {
        ...
        xuLyDangNhap(taiKhoan, pass);
    }//GEN-LAST:event_btnDangNhapMousePressed

    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        txtPass.setText("");
        Application.frmTrangChu.dispose();
        Application.frmTourDaDat.dispose();
    }//GEN-LAST:event_formWindowActivated

    private void btnLoginWithNhanVienMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnLoginWithNhanVienMousePressed
        Application.frmDangNhapNV.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_btnLoginWithNhanVienMousePressed

    private void btnDangKyMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDangKyMousePressed
        Application.frmDangKyKH.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmDangNhapKhachHang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmDangNhapKhachHang().setVisible(true);
            }
        });
    }
    ...
    private custom_components.ButtonCustom btnLoginWithNhanVien;
